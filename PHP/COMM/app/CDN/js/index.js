(function () {
  ...
  var API_KEY = "H5lLtUUVTWq2BTw-ICNX9g";
   ...
   */
  var API_SECRET = "1ja0rXBkPuD5BAnGZ49IzSnurEHdW8koC97k";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/SALON/TEST_COMM/app/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/SALON/TEST_COMM/app/CDN/meeting.html?" +
